...
//------------------------------------------------------------------------
//  Base class for all correlations
//------------------------------------------------------------------------
class CCorrFtnBase {
...
public:
    ...
    // create
    CCorrFtnBase(string p1 = "", string p2 = "", bool bQ = false) :
        particle1(p1), particle2(p2), bigQ(bQ) {}
    CCorrFtnBase(const CCorrFtnBase& m) : 
        particle1(m.particle1), particle2(m.particle2), bigQ(m.bigQ){}
    virtual ~CCorrFtnBase(void){}
    ...
    // CopyState
    virtual void CopyState(const CCorrFtnBase& A)
